...
#export female=/d/tmp/regeps/regep00/studies/pilots/analyses/rerpc/xyrnaseq_rna_mrna_redld/XY_RNAseq/Make_references/gencode/GRCh38.p12.genome.XXonly.fa
...
rule HISAT_samSub_chrX_bam_males:
    ...
    conda:
        srcdir("../workflow/envs/samtools.yaml")
    shell:
        "{params.samtools} view -b {input.BAM} chrX > {output.subBAM}"
...
rule HISAT_samSub_chrY_bam_males:
    ...
    conda:
        srcdir("../workflow/envs/samtools.yaml")
    shell:
        "{params.samtools} view -b {input.BAM} chrY > {output.subBAM}"
